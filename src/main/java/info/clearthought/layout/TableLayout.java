 ...
 * read from top to bottom and no bottom-to-top orientation is defined in <code>java.awt.ComponentOrientation.</code>
 * </p>
 * 
 * <p>
 * For components using the <code>ComponentOrientation.LEFT_TO_RIGHT</code> orientation, the leading edge is the left
 ...
 * <code>setHGap</code> and <code>
 * setVGap</code> methods may be used. To vary the size of gaps, simply use empty rows and columns with absolute sizes.
 ...
 * sizes using either a TableLayout constructor or the <code>insertRow</code> and <code>insertColumn</code> methods.
 ...
 * <code>MINIMUM</code> that does a similar task using components' minimum sizes instead of their preferred sizes.
 * </p>
 * 
 * <p>
 * There is no corresponding <code>MAXIMUM</code> constant for several reasons. First, it is mathematically impossible
