...
public class TableLayoutConstraints implements TableLayoutConstants {
   ...
   *
   * @param constraints indicates TableLayoutConstraints's position and justification as a string in the form
   *        "column, row" or "column, row, horizontal justification, vertical justification" or "column 1, row 1, column
   *        2, row 2" or "column 1, row 1, column 2, row 2, horizontal justification, vertical justification". It is
   *        also acceptable to delimit the parameters with spaces instead of commas.
   */
